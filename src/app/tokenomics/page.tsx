        ...
        <div className="flex flex-col items-center justify-center min-h-screen">
          ...
          <div className="max-w-4xl w-full p-6 md:rounded-lg shadow-lg bg-white my-8" style={{ boxShadow: '0 -4px 8px -6px rgba(0,0,0,0.3)' }}>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600 text-center">
              <li><strong>For the writers:</strong> To publish news, you will need to lock a certain amount of the token in the smart contract for the duration of the season, e.g., 1 month. Depending on the news' rating, the writer will either lose the locked amount or earn additional tokens.</li>
